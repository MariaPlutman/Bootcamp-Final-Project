...
class RequestForm(FlaskForm):
	project = SelectField(choices=['Skillz', '10 אצבעות (Matific)', 'plethora', 'icode', 'accelium', 'רובוטיקה', 'אחר'])
	...
	problem_type = SelectField(choices=['אחר','איטיות','בעית התחברות','הרצת סבב','הרשאה לרכז רשום','כניסה לתחרות','לא עובר לשלב הבא','לוח תוצאות','מערכת לא עובדת','רישום','שאלה בקוד','שאלה בתוך המשחק','שיווק','שפות'])
	status = SelectField(choices=['פנייה חדשה','בטיפול','טופל'])
	external_care = SelectField(choices=['skillz','matific','plethora','accelium','icode','רובוטיקה', 'פורטל'])
